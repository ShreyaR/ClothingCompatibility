...
opt = "SGD"
minibatch_size = 64
training_datadir = '/data/srajpal2/AmazonDataset/Triplets/similarity_training/Training2/'
...
def perform_validation(checkpoint, iteration_num, prev_checkpoint):
	...
	os.system("python similarity_validation.py %s %s %s %d %d %d %s %f" % (checkpoint, validation_data, valloss_file, image_size, primary_embedding_dim, iteration_num, prev_checkpoint, margin))
	return
